 ...
 */
//
//  BTCMnemonicTests.swift
//  CoreBitcoin
//
//  Created by Robert S Mozayeni on 10/17/15.
//  Copyright © 2015 Oleg Andreev. All rights reserved.
//

import XCTest

class BTCMnemonicTests: XCTestCase {
    ...
    func testStandardTestVectors() {
        ...
        for (a,b,c) in testVectors {
            ...
            do { // Test when using entropy
                ...
                XCTAssertEqual(mnemonic3.seed, seed, "Should create correct seed from the words.")
            ...
            do { // Test when using words without a password
                ...
                XCTAssertEqual(mnemonic.entropy, entropy, "Entropy should be extracted from mnemonic.")
                XCTAssertEqual(mnemonic.words as! [String], words, "Should contain the same words with the entropy.")
                XCTAssertNotEqual(mnemonic.seed, seed, "Should not have the correct seed since password is missing")
            }
            ...
            do { //Test when using words without a full wordlist
                ...
                XCTAssertEqual(mnemonic.words as! [String], words, "Should contain the same words with the entropy.")
                XCTAssertEqual(mnemonic.seed, seed, "Should generate a correct seed without consulting a full wordlist.")
            }
    ...
    func testMnemonicsWithoutPassword() {
        ...
        XCTAssertEqual(mnemonic.seed, seed, "Should generate a correct seed.")
    }
