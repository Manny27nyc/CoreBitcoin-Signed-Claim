...
+ (void) testStandardTestVectors {
    ...
    for (NSArray* tuple in testVectors) {
        ...
        NSAssert(seed, @"sanity check");

        // Test when using entropy
        {
            BTCMnemonic* mnemonic = [[BTCMnemonic alloc] initWithEntropy:entropy password:@"TREZOR" wordListType:BTCMnemonicWordListTypeEnglish];
        ...
        {
            BTCMnemonic* mnemonic = [[BTCMnemonic alloc] initWithWords:words password:@"TREZOR" wordListType:BTCMnemonicWordListTypeEnglish];
        ...
        // Test when using words without a password
        {
