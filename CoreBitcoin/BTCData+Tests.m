...
+ (void) runAllTests {
    ...
    NSAssert([[[NSData alloc] init].SHA256.uppercaseHex
              isEqual:@"E3B0C44298FC1C149AFBF4C8996FB92427AE41E4649B934CA495991B7852B855"], @"Test vector");
    NSAssert([BTCDataWithUTF8CString("The quick brown fox jumps over the lazy dog").SHA256.hex
    ...
    NSAssert([BTCDataWithUTF8CString("hello").SHA256.RIPEMD160.hex
              isEqual:@"b6a9c8c230722b7c748331a8b450f05566dc7d0f"], @"Test vector");

    NSAssert([BTCDataWithUTF8CString("hello").BTCHash160.hex
              isEqual:@"b6a9c8c230722b7c748331a8b450f05566dc7d0f"], @"Test vector");

    NSAssert([BTCDataFromHex(@"deadBEEF") isEqualToData:[NSData dataWithBytes:"\xde\xad\xBE\xEF" length:4]], @"Init data with hex string");
    ...
    NSAssert([[[@"6h8cQN" dataFromBase58] hex] isEqual:@"deadbeef"], @"Decodes base58");
    NSAssert([[[@"1JwSSubhmg6iPtRjtyqhUYYH7bZg3Lfy1T" dataFromBase58Check] hex] isEqual:@"00c4c5d791fcb4654a1ef5e03fe0ad3d9c598f9827"], @"Decodes base58 with checksum");
...
//        }
//
//        NSLog(@"BTCCoinFlipDataWithLength: %@", [data subdataWithRange:NSMakeRange(0, 32)].hex);
//    }
}
